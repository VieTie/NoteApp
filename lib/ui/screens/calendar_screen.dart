        ...
        children: [
          TableCalendar(
              ...
              headerStyle: HeaderStyle(
                  leftChevronIcon:
                      Icon(Icons.chevron_left, color: mainColor, size: 24.0),
                  rightChevronIcon:
                      Icon(Icons.chevron_right, color: mainColor, size: 24.0),
                  //formatButtonVisible: false,
                  titleCentered: true,
                  titleTextStyle: TextStyle(color: mainColor, fontSize: 20.0),
